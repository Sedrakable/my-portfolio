        ...
        {tabs.map((tab, index) => {
          return (
            <div className="box">
              ...
              {tab.component}
              {tabs.length - 1 > index && (
                <ScrollButton customClickEvent={scrollPage} />
              )}
            </div>
          );
        })}
...
//     console.log(e);
//     e.preventDefault();
//     this.container.current.childNodes[index].scrollIntoView({
//       behavior: "smooth",
//     });
//   };
...
//     const observer = new IntersectionObserver((entries) => {
//       entries.forEach((entry) => {
//         const tabs = this.navColumn.current.querySelector(".tabs").childNodes;
...
//       <div className="App">
//         <Background />
//         <Navbar ref={this.nav} tabs={tabs} customClickEvent={this.scrollTab} />
//         <NavbarColumn
//           ref={this.navColumn}
//           tabs={tabs}
//           customClickEvent={this.scrollTab}
//           icons={icons}
//         />
